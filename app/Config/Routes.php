...
$routes->post('/members/delete/(:num)', 'MemberController::delete/$1', ['filter' => 'auth']);
...
$routes->post('/structures/delete/(:num)', 'StructureController::delete/$1', ['filter' => 'auth']);
...
$routes->post('/meetings/delete/(:num)', 'MeetingController::delete/$1', ['filter' => 'auth']);
...
$routes->post('/attendances/delete/(:num)', 'AttendanceController::delete/$1', ['filter' => 'auth']);
...
$routes->post('/cash/delete/(:num)', 'CashTransactionController::delete/$1', ['filter' => 'auth']);
...
$routes->post('/content-studio/delete/(:num)', 'ContentStudioController::delete/$1', ['filter' => 'auth']);
...
$routes->get('/settings/website', 'SiteSettingController::index', ['filter' => 'auth']);
$routes->post('/settings/website/update', 'SiteSettingController::update', ['filter' => 'auth']);